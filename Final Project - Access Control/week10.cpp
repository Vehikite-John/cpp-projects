...
* gets permissions
**********************************************/
Permission BellLaPadula::getPermissions() { return permission; }

/***********************************************
* GETUSER
* gets user
**********************************************/
string BellLaPadula::getUser() { return user; }
...
bool StudentGrade::editScores(BellLaPadula b)
{
	...
	bool isAuthorized = (b.getPermissions() == ADMIN);
